...
void fpga1_gt(stage1_args_t s1_args, stage2_args_t s2_args)
{
    ...
    stage2_gt(q, k, v, s1_args.in, s2_args.out, s2_args.scores_scale, s2_args.M_attention_probs, s2_args.M_attention_out,
              s2_args.M_dense_out, s2_args.norm_weight, s2_args.norm_bias, s2_args.M_stage2);
}
...
void fpga1(stage1_args_t s1_args, stage2_args_t s2_args)
{
    ...
    stage2(q, k, v, s1_args.in, s2_args.out, s2_args.scores_scale, s2_args.M_attention_probs, s2_args.M_attention_out,
              s2_args.M_dense_out, s2_args.norm_weight, s2_args.norm_bias, s2_args.M_stage2);
}
